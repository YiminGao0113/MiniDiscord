...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'AHHHHHHHHHAHAHA'
...
def signup():
    ...
    if form.validate_on_submit():
        try:
            ...
            new_user = User(username=form.username.data, email=form.email.data, password=hashed_password, email_confirmed=0)
            send_email(new_user)
...
def send_email(user):
    ...
    <html>
      ...
      <body>
        ...
        http://yimindiscord.com:5000/{user.username}
        </p>
      </body>
    </html>
    """
